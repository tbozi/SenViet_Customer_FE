...
const dictionaries = {
  vi: {
    ...
    auth: {
      ...
      registerTitle: "Thêm khách hàng mới",
      registerSubtitle: "Nhập thông tin cơ bản để tạo nhanh hồ sơ lưu trú cho khách hàng.",
      accountInfoTitle: "Thông tin tài khoản",
      accountInfoSubtitle: "Nhập email và mật khẩu để hoàn tất thông tin tài khoản khách hàng.",
      ...
      registerButton: "Thêm khách hàng",
  ...
  en: {
    ...
    auth: {
      ...
      registerTitle: "Add new customer",
      registerSubtitle: "Enter basic information to quickly create a customer stay profile.",
      accountInfoTitle: "Account information",
      accountInfoSubtitle: "Enter an email and password to complete the customer account.",
